...
___Important note: this section of the post relies heavily on___ https://github.com/DavisVaughan/2020-06-01_dplyr-vctrs-compat.
...
Each of the three options for registering S3 methods has different benefits and downsides, so the choice depends on the specific use-case.
