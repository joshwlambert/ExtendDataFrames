...
this aspect later. The role of the class -- and it's important that a well-
designed class has a role, otherwise just using the build in data frame will 
...
already written for data frames, and can overwrite (overload) these method with
...
do not already have a define generic function. Here we write a 
